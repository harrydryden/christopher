...
export default async function CvPage({ searchParams }: { searchParams: Promise<{ job?: string; q?: string; page?: string; archivedPage?: string }> }) {
  ...
  return <div className="max-w-4xl space-y-6">
    ...
    <Card title="Create a role-specific CV"><SettingsForm action={requestCv} submitLabel="Generate CV">
      ...
      <section><h3 className="text-sm">Paste or override the job description</h3><textarea name="description" rows={7} maxLength={60000} placeholder="Leave blank to use the scraped description." className="mt-2 w-full rounded border p-2 text-sm dark:bg-slate-950" /></section>
