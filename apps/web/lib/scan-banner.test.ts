...
it("identifies batch scope, local start time and incomplete companies", () => {
  expect(scanBannerText(run, "Europe/London", now)).toBe("Scheduled batch · Today 06:00 · 3 of 4 of your companies successful · 1 incomplete or failed · 0 new postings observed");
});
