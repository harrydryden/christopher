...
it("identifies batch scope, local start time and incomplete companies", () => {
  expect(scanBannerText(run, "Europe/London", now)).toBe("Scheduled batch · Today 06:00 · 3 of 4 of your companies successful · 1 incomplete or failed · 0 new postings for your table");
});
...
it("labels empty scheduled batches without implying all tracked companies were scanned", () => {
  expect(scanBannerText({ ...run, companiesTotal: 0 }, "Europe/London", now)).toContain("None of your companies were due");
