 ...
 *
 * Accounts are members unless a test asks for an administrator. Nearly every account is a member,
...
export async function ensureTestUser(db: Db, email = "tester@example.com", role: "admin" | "member" = "member") {
...
export async function signInTestUser(db: Db, secret: string, email = "tester@example.com", role: "admin" | "member" = "member") {
