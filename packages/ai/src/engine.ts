import { CV_LIMITS, CvPlanSchema, type CvPlan, type CvLibrary } from "@christopher/core";
...
export class AiEngine {
  ...
  async buildCv(input: { library: CvLibrary; jobTitle: string; company: string; description: string; layoutFeedback?: { pageCount: number; maxPages: number; previousPlan: CvPlan } }, ref: Ref = {}): Promise<CvPlan | null> {
